...
<div class="container theme-showcase" role="main">
    ...
    <div style="padding-top:10px;">
        ...
        <button id="addBtn" type="button" class="btn btn-danger btn-lg btn-block" >认证申请</button>
    </div> <!-- /container -->
    <!-- /END THE FEATURETTES -->
    ...
    <script>
        ...
        $("#addBtn").click(function () {
            var accttype =   $(".seltype").parent().attr("accttype");
            window.location.href = "${APP_PATH}/member/selectAcctType.do?accttype="+accttype;
